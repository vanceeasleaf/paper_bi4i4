...
% @Last Modified time: 2017-06-21 02:50:42
\documentclass[%
 reprint,
 amsmath,amssymb,
 aps,
...
\begin{figure}[b]
\includegraphics[width=0.4\textwidth]{images/structure}
...
\begin{figure}[b]
\includegraphics[width=0.4\textwidth]{images/phonon}
...
To further study its thermal stability at finite-temperature, we performed ab initio molecular dynamics (MD) simulations at typical temperatures and the results of Mean Square Displacement(MSD)\cite{Michalet2010} are shown in FIG.3. The MSD is defined as
